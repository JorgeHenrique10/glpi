			...
			<div id="charts" class="fluid chart">
				<div id="pad-wrapper">
					...
					<div id="head-rel" class="fluid">
						...
						<div id="titulo_rel"> <?php echo _('Summary Report', 'dashboard') . '  ' . _('', 'dashboard') ?> </div>
			...
			//Médias de Dias
				...
				$dias_aditivo = (int) $DB->result($result_dias_aditivo, 0, 'dias');
						...
						";
							...
							$entidade
						";
// print_r($query_chamados_aditivo);
		...
		// print_r('Cotação: ');		
		// print_r($qtd_dias_cotacao_2);
		// print_r('<br>');
		// print_r($qtd_dias_cotacao_1);
		// print_r('<br>');
		// print_r('Dispensa: ');		
