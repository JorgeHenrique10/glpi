	...
	<div id='container-fluid' style="margin: <?php echo margins(); ?> ;">
		<div id="charts" class="fluid chart"> 
			...
			<a href="../index.php"><i class="fa fa-home" style="font-size:14pt; margin-left:25px;"></i><span></span></a>
				...
				<form id="form1" name="form1" class="form_rel" method="post" action="sla_contratos.php?con=1" style="margin-left: 37%;"> 
					...
					<tr>
						<td colspan="2" align="center">
							<button class="btn btn-primary btn-sm" type="submit" name="submit"  onclick="location.href='<?php echo $url2.'?con=1'; ?>'" value="Atualizar" ><i class="fa fa-search"></i>&nbsp; <?php echo __('Consult','dashboard'); ?> </button>
...
if($conta_cons_contrato > 0) {
	...
	echo "							
            <table id='sla' class='display'  style='font-size: 12px; font-weight:bold;' cellpadding = 2px>
                <thead>
                    <tr>
                        <th style='text-align:center; cursor:pointer;'> ". __('Solicitações') ." </th>
                        <th style='font-size: 12px; font-weight:bold; text-align: center; cursor:pointer;'> ".__('Total de Chamados')." </th>
                        ...
                        <th style='text-align:center; cursor:pointer;'> ". __('Prazos por dias','dashboard') ."</th>															
                    </tr>
                </thead>
                <tbody> 
                    <tr>
                        ...
                        <td style='vertical-align:middle; text-align:center;'> ". $dias_cotacao ."/41 </td>                        		
                    </tr>
                    <tr>
                        ...
                        <td style='vertical-align:middle; text-align:center;'> ". $dias_dispensa ."/20 </td>                        		
                    </tr>
                    <tr>
                        ...
                        <td style='vertical-align:middle; text-align:center;'> ". $dias_aditivo ."/20 </td>                        		
                    </tr>
                    <tr>
                        ...
                        <td style='vertical-align:middle; text-align:center;'> ". $dias_distrato ."/20 </td>                        		
                    </tr>
                </tbody>
            </table>
        </div>
