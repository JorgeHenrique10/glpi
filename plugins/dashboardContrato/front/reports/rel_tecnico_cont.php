...
<a href="../index.php"><i class="fa fa-home" style="font-size:14pt; margin-left:25px;"></i><span></span></a>
    ...
    <div id="titulo_rel" > <?php echo __('Tickets','dashboard') .'  '. __('by Technician','dashboard') ?> </div>
        <div id="datas-tec" class="span12 fluid" >
		    <form id="form1" name="form1" class="form_rel" method="post" action="rel_tecnico_cont.php?con=1">
...
if($con == "1") {	
	...
	if($id_tec == 0) {
		...
		echo '<script language="javascript"> location.href="rel_tecnico_cont.php"; </script>';
	}
	...
	<table id='tec' class='display' style='font-size: 12px; font-weight:bold;' cellpadding = 2px >
		<thead>
			<tr>
				...
				<th style='text-align:center; cursor:pointer;'> ". __('Unidade') ."</th>
...
while($row = $DB->fetch_assoc($result_cham)){
	...
	if($satisfacao != '' || $satisfacao > 0) {
		...
		<tr style='font-size:11px;'>
			...
			<td style='vertical-align:middle; font-weight:normal;'> ". $row_user['unidade'] ." </td>
