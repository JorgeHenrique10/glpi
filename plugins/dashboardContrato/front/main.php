...
<div class="site-holder">
	...
	<div class="content animated fadeInBig corpo col-md-12 col-sm-12 align">
		...
		<div id="panels" class="row">
				...
				<div class="dashbox shad panel panel-default db-red">
					<div class="panel-body">
						...
						<div class="panel-right right">
							<div id="odometer1" class="odometer" style="font-size: 25px;"> </div>
							<p></p>
			...
			<div class="col-md-2 col-sm-2">
				<div class="dashbox shad panel panel-default db-blue">
					<div class="panel-body">
						...
						<div class="panel-right right">
							<div id="odometer2" class="odometer" style="font-size: 25px;"> </div>
							<p></p>
							<span class="chamado"><?php echo __('Tickets', 'dashboard'); ?></span><br>
			...
			<div class="col-md-2 col-sm-2">
				<div class="dashbox shad panel panel-default db-purple">
					<div class="panel-body">
						...
						<div class="panel-right right">
							<div id="odometer3" class="odometer" style="font-size: 25px;"> </div>
							<p></p>
							<span class="chamado"><?php echo __('Tickets', 'dashboard'); ?></span><br>
			...
			<div class="col-md-2 col-sm-2"onClick="redirectClick()">
				<div class="dashbox shad panel panel-default db-dred">
					<div class="panel-body">
						...
						<div class="panel-right right">
							<div id="odometer4" class="odometer" style="font-size: 25px;"> </div>
							<p></p>
							<span class="chamado"><?php echo __('Tickets', 'dashboard'); ?></span><br>
			...
			<div class="col-md-2 col-sm-2">
				<div class="dashbox shad panel panel-default db-brown">
					<div class="panel-body">
						...
						<div class="panel-right right">
							<div id="odometer5" class="odometer" style="font-size: 25px;"> </div>
							<p></p>
			...
			<div class="col-md-2 col-sm-2">
				<div class="dashbox shad panel panel-default db-orange">
					<div class="panel-body">
						...
						<div class="panel-right right">
							<div id="odometer6" class="odometer" style="font-size: 25px;"> </div>
							<p></p>
		...
		<script type="text/javascript">
			function redirectClick() {			
					...
					window.location.href = "reports/rel_tickets.php?con=1&status=99"
				...
				<div id="grfrow" class="row-fluid col-sm-11 col-md-11 card" style="width:100%;">
					...
					<div class="demo-container" style="margin-bottom:10px;">
						...
						<li class="data-row">
									...
									<span class="data-value"  style="display:none;" >';
									include 'sh/mem.php';
			...
			<div id="widgets" class="row">
				...
				<div class="col-sm-6 col-md-6">
					<div id="tickets_age" class="widget widget-table action-table striped card1">
						<div class="widget-header wpurple">
							<h3><i class="fa fa-pie-chart" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><?php echo __('Idade dos Chamados Abertos', 'dashboard'); ?></h3>
							<span class="fa fa-times hide-widget"></span>
						</div>
						<!-- /widget-header -->
						<div id="graf9">
				...
				<div class="col-sm-6 col-md-6">
					<div id="tickets_time" class="widget widget-table action-table striped card1">
						<div class="widget-header wpurple">
							<h3><i class="fa fa-bar-chart-o" style="margin-left:7px;">&nbsp;&nbsp;&nbsp;</i><?php echo __('Tempo de Solução dos Chamados', 'dashboard'); ?></h3>
							<span class="fa fa-times hide-widget"></span>
						</div>
						<!-- /widget-header -->
						<div id="graf8">
							...
							function tipo($type)
							{
								...
								switch ($type) {
									...
									case "ticket":
										...
										break;
									case "devices":
										$type 	  = _sn('Component', 'Components', 2);
										break;
									case "planning":
										$type 	  = __('Planning');
										break;
									case "reservation":
										$type = _sn('Reservation', 'Reservations', 2);
										break;
									case "dropdown":
										$type 	  = _sn('Dropdown', 'Dropdowns', 2);
										break;
									case "rules":
										$type 	  = _sn('Rule', 'Rules', 2);
										break;
								};
								return $type;
							}
							...
							function servico($service)
							{
								...
								switch ($service) {
									...
									case "tools":
										...
										break;
									case "financial":
										$service 	  = __('Management');
										break;
									case "login":
										$service 	         = __('Connection');
										break;
									case "setup":
										$service 	  	  = __('Setup');
										break;
									case "security":
										...
										break;
									case "reservation":
										$service     = _sn('Reservation', 'Reservations', 2);
										break;
									case "cron":
										$service 	  	  = _sn('Automatic action', 'Automatic actions', 2);
										break;
									case "document":
										$service 	  = _sn('Document', 'Documents', 2);
										break;
									case "notification":
										$service    = _sn('Notification', 'Notifications', 2);
										break;
									case "plugin":
										$service 	  = __('Plugin');
										break;
